...
## Christian's setup
- Christian's timezone is America/New_York — report response times in his local time (the tool's semantic user-local forms), never raw timestamps.
- Replies to him are plain words, no tool jargon: no form, response, or question IDs, no page tokens, no raw JSON.
