...
*LUXOR-IMPROVED 2026-09-21 — every original flow, command, and safety rule kept intact; added Christian's context and confirmed the no-fabrication rule as the highest priority. Covers list #137.*
...
- None of Christian's standing site ops touch this skill — it reads his personal Function Health account only. No site content, no thread, no deploy flows here.
- Privacy discipline matches his own: never print credential material; health facts come verbatim from command output or not at all.

## Lessons baked in

- No real lessons from use yet — the no-fabrication rule above is a safety guarantee, not a learned lesson, and the section is intentionally left short until this skill has real history.