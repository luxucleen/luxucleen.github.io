...
> **LUXOR-IMPROVED 2026-09-21** — Added "Christian's setup" (his real creator operating context for music/podcast work) and "Lessons baked in". Covers list numbers **69** as one unit. Every original line kept — only additions.
...
## Christian's setup
- Christian is a content creator — @djbrightfuture / @djbrightfutures (YouTube, Instagram, TikTok, Facebook, X). His own music is the most likely search subject here: use the exact-form query `"<song> by <artist>"` so his originals are never confused with covers or similarly named tracks, and always include the Spotify deep link so he can share it straight to his audience.
- His standing audio workflow is the luxor-recap podcast briefing (Bella/Liam voices) via the podcast skill — Spotify is for his own music and listening, not that pipeline.
- He runs Luxucleen LLC (Richmond, VA area); free-traffic doctrine means his tracks get found through content, not ad spend. No tokens or credentials in chat — OAuth only through the connect flow above.

## Lessons baked in
- No hard-won lessons from real use yet — this section stays short on purpose until one lands.