...
> **LUXOR-IMPROVED — 2026-09-21.** Banner added; noted that no Hue bridge is recorded in Christian's operating context (first real use runs the onboarding Steps 1–4). No original lines changed. Covers list #120 as one unit.
...
- No Hue bridge is recorded in Christian's operating context as of 2026-09-21. First real use runs the onboarding Steps 1–4 above (status → connect → link-bridge → discovery) — nothing invented.

## Lessons baked in

- None from real use yet — no lights have been touched through this skill. Kept short on purpose.