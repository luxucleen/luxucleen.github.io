...
## Christian's setup
- Replies to him are plain words, no tool jargon: a contact's name, email, and phone number are what he asked for — never commands, IDs, etags, or status words.
- Contact changes reach real people: resolve the exact person with a search or browse first (already the rule above), and never act on a contact that was not found.
